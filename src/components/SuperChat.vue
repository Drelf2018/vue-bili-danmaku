        ...
        <div id="header-content-primary-column" class="no-transition style-scope yt-live-chat-paid-message-renderer">
          ...
          <div id="purchase-amount" class="style-scope yt-live-chat-paid-message-renderer"
            ...
            <span style="float: right">{{
                ts == 0 ? '获取失败' : new Date(ts * 1000).Format("hh:mm:ss")
            }}</span>
          </div>
        </div>
      </div>
...
#header.yt-live-chat-paid-message-renderer {
  position: relative;
  background-color: var(--yt-live-chat-paid-message-header-background-color,
      #125aac);
...
html:not(.style-scope) {
  ...
  --yt-live-chat-action-panel-background-color-transparent: hsla(0,
      0%,
      97%,
      0.8);
  ...
  --yt-live-chat-additional-inline-action-button-background-color: hsla(0,
      0%,
      26%,
      0.8);
  --yt-live-chat-additional-inline-action-button-background-color-hover: hsla(0,
      0%,
      26%,
      1);
